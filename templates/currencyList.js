...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // currency data pulled from the api to be used
    const currencies = [
    ...
    function populateCurrencySelect(selectId, currencies) {
    ...
    populateCurrencySelect('fromCurrency', currencies);
    populateCurrencySelect('toCurrency', currencies);
});
